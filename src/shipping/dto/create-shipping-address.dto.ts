...
export class CreateShippingAddressDto {
  ...
  @Matches(/^[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+$/, { message: 'El nombre solo debe contener letras' })
  firstName: string;

  @IsString()
  @IsNotEmpty({ message: 'El apellido es obligatorio' })
  @Length(2, 30, { message: 'El apellido debe tener entre 2 y 30 caracteres' })
  @Matches(/^[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+$/, { message: 'El apellido solo debe contener letras' })
  lastName: string;
  ...
  @Matches(/^[a-zA-ZáéíóúÁÉÍÓÚñÑ ]+$/, { message: 'La ciudad solo debe contener letras' })
  city: string;
  ...
  @Matches(/^9\d{8}$/, { message: 'El teléfono debe empezar con 9 y tener 9 dígitos' })
  phone: string;
